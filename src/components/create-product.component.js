...
const exchangeRate = 90; // Assume 1 Euro = 90 Rupees (replace with the correct exchange rate)
...
export default class CreateProduct extends Component {
  ...
  onSubmit(e) {
    ...
    // Convert the price from euros to rupees
    const priceInRupees = this.state.price * exchangeRate;
